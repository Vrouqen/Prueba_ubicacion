CREATE TABLE Incomes(
    id_income INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    id_user INT,
    value DECIMAL(10,2),
    date DATETIME
);
...
CREATE TABLE Incomes_Names(
    id_name_income INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    id_income INT,
    name VARCHAR(50),
...
CREATE TABLE Type_Income(
    id_type_income INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    id_income INT,
